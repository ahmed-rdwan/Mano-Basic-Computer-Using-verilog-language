...
HD_PWD='C:/Users/taker/my_mano/my_mano.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ARCHITECTURE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ARCHITECTURE.tcl
