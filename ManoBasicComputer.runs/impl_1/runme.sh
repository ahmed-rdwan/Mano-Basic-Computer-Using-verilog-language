...
HD_PWD='C:/Users/taker/my_mano/my_mano.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ARCHITECTURE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ARCHITECTURE.tcl -notrace
